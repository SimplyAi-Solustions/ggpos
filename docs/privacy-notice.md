...
This notice explains how GG Entertainment collects and uses your personal data when you sell to us, buy from us, join GG Guild, or use My Vault. We show it at the counter and in the My Vault portal.

## Who we are

GG Entertainment ("we", "us") trades from [shop address], Bolsover, Chesterfield. Company number: [placeholder, if registered]. See "Contact us" below for anything about your data.

## What we collect, and why

**Trade-in records.** When you sell items to us, we record what you sold, when, and what we paid. We need this to run the shop, to price fairly, and because tax law requires us to keep sales and purchase records.
...
We do not sell your data, and we do not share it with anyone else without telling you, unless the law requires it.
...
If you are unhappy with how we have handled your data, tell us first (see "Contact us"); we will acknowledge your complaint within 30 days. If you are not satisfied with our answer, you can complain to the Information Commissioner's Office at ico.org.uk, or on 0303 123 1113.

## Contact us

[Shop email address]
[Shop phone number]
[Shop postal address], Bolsover, Chesterfield
